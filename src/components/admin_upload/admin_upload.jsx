...
import Batch from "./batch_upload.jsx";
...
const AdminUpload = () => {
    ...
    return (
        <div className="admin-upload-main-container">
            {/* 1) Upload New Shortlist Project */}
            ...
            <div className="upload-attorney-images-container">
                <div className="section-title">Upload Attorney Images</div>
                    ...
                    <div className="attorney-image-upload-list">
                        {missingImages.map((attorney) => (
                            <form
                                ...
                                onSubmit={async (e) => {
                                    e.preventDefault();
                                    const f = e.target.elements[`image-${attorney.attorney_id}`].files[0];
            ...
            {/* 3) Download Shortlist */}
            <div className="attorney-shortlist-download-container">
                <div className="project-select-wrapper">
                    <label htmlFor="project-select-2">Select Project: </label>
                    <select
                        id="project-select-2"
                        className="admin-upload-project-select"
                        value={selectedValue}
            ...
            <div className="batch-upload-container">
                <Batch
                    attorneys={missingImages}
                    setMissingImages={setMissingImages}
